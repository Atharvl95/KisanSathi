                ...
                {loginSuccess ? (
                  <div className="flex flex-col items-center text-center py-8 gap-4">
                    <div className="w-20 h-20 rounded-full flex items-center justify-center text-4xl"
                      style={{ background: "#f0fdf4", border: "3px solid #86efac" }}>🎉</div>
                    <h3 className="text-2xl font-black" style={{ color: "#14532d", fontFamily: "'Playfair Display', serif" }}>
                      Welcome Back!
                    </h3>
                    <p className="text-gray-500 text-sm max-w-xs">You've logged in successfully. Redirecting to your dashboard...</p>
              ...
              <div className="form-enter">
                {signupSuccess ? (
                  <div className="flex flex-col items-center text-center py-8 gap-4">
                    ...
                    <p className="text-gray-500 text-sm max-w-xs">Welcome to Kisansathi! Your account is ready. Setting up your dashboard...</p>
                    <div className="w-8 h-8 rounded-full border-4 border-green-200 border-t-green-600 spin mt-2"/>
                  </div>
                ) : (
                  <>
                    <div className="mb-7">
                      ...
                      <p className="text-sm text-gray-400 mt-1">Join 500+ farmers growing smarter</p>
                    </div>
